...
import { chatCache, cacheChatMessages, getCachedChatMessages, clearChatCache } from '@/utils/cache'
...
export const useMessageStore = defineStore('message', () => {
  ...
  const unreadCount = computed(() => {
    return messages.value.filter(m => m.type === 'response' && !m.read && m.done).length
  })
